...
export default function SignInForm() {
    ...
    return (
        <div className="flex flex-col w-auto gap-2 p-4">
            ...
            <button className="bg-slate-200 rounded-xl py-1 px-2 mt-2 text-slate-800 hover:bg-inherit hover:text-slate-300 hover: border hover:border-slate-200" onClick={handleSubmit}>Sign In</button>
        </div>
    )
}